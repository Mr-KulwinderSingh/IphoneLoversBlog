# Generated by Django 3.2.22 on 2023-10-18 21:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='iphoneblog.post')),
            ],
            options={
                'ordering': ['created_on'],
            },
